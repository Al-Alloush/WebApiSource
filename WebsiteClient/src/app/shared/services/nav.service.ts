...
export class NavService {
	...
	MENUITEMS: Menu[] = [ 
		{ path: '/home', title: 'home', active: false, type: 'link' },
		{ path: '/shop/foods', title: 'shop', active: false, type: 'link' },
		{ path: '/pages/aboutus', title: 'about-us', active: false, type: 'link' },
		{ path: '/pages/contact', title: 'contact', active: false, type: 'link' }
	];
